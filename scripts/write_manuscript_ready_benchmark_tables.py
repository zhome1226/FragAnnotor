    ...
    blocker_rows.extend(
        [
            ...
            },
            {
                "model": "MS2DeepScore",
                "native_available": False,
                "executable_or_package": "ms2deepscore/matchms package install attempted in user-space venv",
                "version": ms2_audit.get("package_version", ""),
                "blocker": ms2_audit.get("benchmark_decision", ""),
                "subset_status": "blocked_no_pretrained_model_or_complete_candidate_spectrum_library",
            },
        ]
    )
