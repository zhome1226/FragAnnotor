...
def main() -> None:
        ...
        [
            {
                ...
                "complete_query_expansion_status": (
                    f"partial query={cfmid_complete_query_expansion.get('query_id')} "
    ...
    report = [
        ...
        "- A second complete-query CFM-ID expansion attempt is recorded separately as partial runtime evidence and is excluded from Table 1 metrics until all candidate spectra and ranks are available.",
