...
def main() -> None:
    ...
    partial_attempt_status = ""
    if not cfmid_complete_query_partials.empty:
        parts = []
        ...
        partial_attempt_status = "; ".join(parts)
        ...
        [
            {
                ...
                "complete_query_expansion_status": partial_attempt_status,
                "full_run_manifest": (
    ...
    report = [
        ...
        "- Partial CFM-ID complete-query attempts are recorded separately and excluded from complete-query subset Top-k/MRR until all candidate spectra are generated and ranked.",
    ...
    write_json(
        OUTDIR / "audit_summary.json",
        {
            ...
            "cfmid_complete_query_partial_attempt_count": int(len(cfmid_complete_query_partials)) if not cfmid_complete_query_partials.empty else 0,
