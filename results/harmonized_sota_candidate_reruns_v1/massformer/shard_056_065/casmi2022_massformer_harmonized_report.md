...
- `n_queries_completed`: `8`
- `n_rank_valid_queries`: `8`
- `candidate_limit`: `-1`
- `candidate_pool_policy`: `full_query_candidate_set`
- `score_name`: `binned_cosine_1Da`
- `top1_accuracy`: `0.0`
- `top5_accuracy`: `0.125`
- `top10_accuracy`: `0.125`
- `mean_reciprocal_rank`: `0.06578781407170138`
- `mean_top1_tanimoto`: `0.2261925987251068`
- `formula_accuracy`: `0.875`
- `total_candidate_rows_scored`: `44681`
- `total_failed_predictions`: `15`
