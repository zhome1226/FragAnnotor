...
Complete-query native CFM-ID precomputed subset evidence is available at `results/casmi2022_cfmid_native_precomputed_complete_query_subset_v1/`: `9` selected supported `[M+H]+` CASMI queries, full candidate sets for each selected query, Top-1 `0.0`, Top-5 `0.2222222222222222`, Top-10 `0.2222222222222222`, and MRR `0.0867169776795859`.
The subset output is rebuilt from completed ranked work directories, and partial attempts are not counted in Top-k/MRR. Partial complete-query attempts excluded from metrics: query 177 status `partial_or_unranked` with `117/336` candidate spectra.
...
Complete-query CFM-ID + MS2DeepScore hybrid subset evidence is available for `9` selected queries with full candidate sets: Top-1 `0.0`, Top-5 `0.2222222222222222`, Top-10 `0.3333333333333333`, and MRR `0.0813970070214396`.
